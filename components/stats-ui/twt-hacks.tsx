  ...
  return (
    <div
      className={cn(
        ...
        "transition-all duration-200 ease-in-out hover:bg-zinc-800/50",
...
export function TwitterHacks() {
  return (
    <Card className="bg-zinc-900 shadow-sm h-full border-zinc-800">
      <CardHeader className="pb-2">
        <CardTitle className="text-lg font-medium tracking-tight text-white">Latest Twitter Hacks</CardTitle>
      </CardHeader>
      <CardContent className="p-4">
        <div className="relative h-[350px] overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-zinc-900 to-transparent"></div>
        </div>
      </CardContent>
    </Card>
  );
