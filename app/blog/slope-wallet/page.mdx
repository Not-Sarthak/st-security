...
<Image src="/content/slope/slope1.png" alt="Slope" width={500} height={500} className="mx-auto" />
...
<Image src="/content/slope/slope2.png" alt="Slope" width={500} height={500} className="mx-auto" />
...
- 2nd August 2022, around 11 PM UTC:
    ...
    <Image src="/content/slope/slope3.png" alt="Slope" width={500} height={500} className="mx-auto" />
...
- 3rd August:
    ...
    <Image src="/content/slope/slope4.png" alt="Slope" width={500} height={500} className="mx-auto" />
    
    - Anatoly - cofounder of Solana - raised a possibility of an "[iOS supply chain attack](https://x.com/aeyakovenko/status/1554891864066600960)".
      ...
      - He confirms that most of the Phantom users were using Slope so posits that the root cause was mostly Slope.

- 4th August:
    - Slope Finance (the team behind Slope Wallet) issues a statement confirming the breach.
    <Image src="/content/slope/slope5.png" alt="Slope" width={500} height={500} className="mx-auto" />
...
<Image src="/content/slope/slope6.png" alt="Slope" width={500} height={500} className="mx-auto" />
...
- Suppose you're a developer building a mobile cryptocurrency wallet app that allows users to store, manage, and transfer various cryptocurrencies. As a developer, you want to ensure that the app runs smoothly and securely, providing users with a reliable and user-friendly experience.
...
More analysis on how much was lost in which assets can be found [here](https://x.com/Tristan0x/status/1554831086806372352?s=20).

## Technical Explanation:
### The Leak:
Ottersec - a web3 audit company - reported that they had confirmed that Slope&apos;s mobile app sends off mnemonics via TLS to their centralized Sentry server.
...
<Image src="/content/slope/slope7.png" alt="Slope" width={500} height={500} className="mx-auto" />
...
Further, [statement by Sentry](https://blog.sentry.io/slope-wallet-solana-hack/) reveals that:
...
3. [Statement by Sentry](https://blog.sentry.io/slope-wallet-solana-hack/)